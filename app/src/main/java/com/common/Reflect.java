...
public class Reflect {
    ...
    static public Map<Pattern, ObjectReflect> filterReflectType = new HashMap<>();
    static public Map<Pattern, ObjectReflect> filterReflectName = new HashMap<>();
    ...
    static {
        ...
        ObjectReflect nullReflect = new ObjectReflect() {
            @Override
            public Object Reflect(Object obj) {
                return null;
            }
        };
        ObjectReflect toStringReflect = new ObjectReflect() {
            @Override
            public Object Reflect(Object obj) {
                return obj.toString();
            }
        ...
        filterReflectName.put(Pattern.compile("mLock"), nullReflect);

        filterReflectType.put(Pattern.compile("java.net.InetAddress"), toStringReflect);
        filterReflectType.put(Pattern.compile("java.net.Inet4Address"), toStringReflect);
        filterReflectType.put(Pattern.compile("java.net.Inet6Address"), toStringReflect);
        filterReflectType.put(Pattern.compile("android.net.IpPrefix"), toStringReflect);
//      filterReflectType.put(Pattern.compile("android.*"), doNotReflect);
//      filterReflectType.put(Pattern.compile("androidx.lifecycle.*"), doNotReflect);
//      filterReflectType.put(Pattern.compile("dalvik.*"), doNotReflect);
//      filterReflectType.put(Pattern.compile("libcore.io.*"), doNotReflect);
//      filterReflectType.put(Pattern.compile("sun.misc.Cleaner"), doNotReflect);
//      filterReflectType.put(Pattern.compile("java.lang.ClassLoader"), doNotReflect);
//      filterReflectType.put(Pattern.compile("java.lang.Package"), doNotReflect);
//      filterReflectType.put(Pattern.compile("java.lang.File"), doNotReflect);
//      filterReflectType.put(Pattern.compile("java.util.jar.JarFile"), doNotReflect);
    }

    static public ObjectReflect GetCustomNameReflect(String name) {
        for (Pattern item : filterReflectName.keySet()) {
            if (item.matcher(name).find()) {
                return filterReflectName.get(item);
            }
        }
        return null;
    }
    ...
    static public ObjectReflect GetCustomTypeReflect(Class cls) {
        for (Pattern item : filterReflectType.keySet()) {
            if (item.matcher(cls.getName()).find()) {
                return filterReflectType.get(item);
            }
        }
        return null;
    }
        ...
        public JSONObject ReflectGetFieldsObj(Class _class, Object target, int deep) {
            ...
            for (Field field : fields) {
                ...
                try {
                    ...
                    ObjectReflect nameFilter = GetCustomNameReflect(fieldName);
                    if (nameFilter != null) {
                        json.put(fieldName, nameFilter.Reflect(target));
                        continue;
                    }
